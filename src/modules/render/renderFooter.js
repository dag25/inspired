...
export const renderFooter = () => {
	...
	container.insertAdjacentHTML(
		...
		<div class="footer__item  footer__item--social  footer-social">
			<h2 class="footer__title  footer-social__title">
				Связаться с нами
			</h2>
			<p class="footer-social__subtitle">
				Контакты и адреса магазинов
			</p>
			<ul class="footer-social__list">
				<li class="footer-social__item">
					<a class="footer-social__link  footer__link  footer-social__link--vk" href="#">
				...
				<li class="footer-social__item">
					<a class="footer-social__link  footer__link  footer-social__link--fb" href="#">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							<path
		...
		<div class="footer__item  footer__item--contacts  footer-contacts">
			<a class="footer-contacts__mail  footer__link" href="mailto:Inspired@gmail.com">
				Inspired@gmail.com
			</a>
			<a class="footer-contacts__phone  footer__link" href="tel:89304902620">
				8 930 490 26 20
			</a>
		</div>
		...
		<div class="footer__item  footer__item--development  footer-development">
			<ul class="footer-development__list">
				<li class="footer-development__item">
					Designer:
					<a class="footer-development__link  footer__link" href="#">
						Anastasia Ilina
					</a>
				</li>
				<li class="footer-development__item">
