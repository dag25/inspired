...
export const favoriteLink = createElement(
	'a',
	{
		className: 'header__link',
		innerHTML: `
...
createElement(
	...
	{ className: 'header__nav-list' },
	{
		parent: nav,
		appends: [
			createElement('li', { className: 'header__nav-item' }, { append: searchButton }),
			createElement('li', { className: 'header__nav-item' }, { append: cartLink }),
			createElement('li', { className: 'header__nav-item' }, { append: favoriteLink }),
		],
	},
);
